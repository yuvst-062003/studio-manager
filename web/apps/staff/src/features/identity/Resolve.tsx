// §6.1's staff-app first launch, step 3's non-refusal arms:
//
...
// that file's header for why. Everything here now runs under the guarantee `AccessGate`
// provides: `session.access.staff` is `true`.
//
