...
describe('staff app', () => {
  it('renders §6.5 install walkthrough while running in a tab', async () => {
    ...
    // mode' — so in a tab this is the whole app, not a banner beside it. For the staff
    // app §10.6 makes it load-bearing rather than nice: pending_ops must never be
    // reclaimed, and only a home-screen web app is exempt from Safari's 7-day cap.
    render(<App />)
