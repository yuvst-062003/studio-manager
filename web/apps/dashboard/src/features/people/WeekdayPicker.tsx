// C12's day checkboxes for dashboard `3c`.
//
...
// NULL survives a schedule change; "every session of this group" means the same thing
// before and after.
//
// **This is a near-copy of the staff app's WeekdayPicker, and that is a known cost.** Apps
// are leaves — `@studio/dashboard` does not depend on `@studio/staff`, and it should not
// start — so the only place a genuinely shared version could live is `@studio/ui`, which
// this lane does not own. Both copies are presentational and both are tested where they
// are used; whoever next owns `@studio/ui` should lift one and delete the other.
