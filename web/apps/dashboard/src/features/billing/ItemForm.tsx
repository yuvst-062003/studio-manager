...
import { Button, Card, Switch, TextField } from '@studio/ui'
import { t } from '@studio/i18n'
import type { Locale } from '@studio/i18n'
import { agorotFromShekels } from './money'
import type { ProductInput, ProductOut } from './billingClient'
...
export function draftFrom(product: ProductOut): ItemDraft {
...
export function toInput(draft: ItemDraft): ProductInput {
  return {
