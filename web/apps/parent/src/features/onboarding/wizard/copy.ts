...
export function step2Copy(locale: Locale) {
  return {
    ...
    trialChip: t(locale, 'people.joinWizard.step2.trialChip'),
...
export function studentFormCopy(locale: Locale) {
  return {
    ...
    addTrialTitle: t(locale, 'people.joinWizard.form.addTrialTitle'),
    stepOf: t(locale, 'people.joinWizard.form.stepOf'),
    editTitle: t(locale, 'people.joinWizard.form.editTitle'),
    cancel: t(locale, 'people.joinWizard.form.cancel'),
    discardTitle: t(locale, 'people.joinWizard.form.discardTitle'),
    discardBody: t(locale, 'people.joinWizard.form.discardBody'),
    discardKeep: t(locale, 'people.joinWizard.form.discardKeep'),
    discardConfirm: t(locale, 'people.joinWizard.form.discardConfirm'),
    ...
    aliyahYearHint: t(locale, 'people.joinWizard.form.aliyahYearHint'),
    guardianAliyahYear: t(locale, 'people.joinWizard.form.guardianAliyahYear'),
    parentTab1: t(locale, 'people.joinWizard.form.parentTab1'),
    parentTab2: t(locale, 'people.joinWizard.form.parentTab2'),
    parentTabAdd: t(locale, 'people.joinWizard.form.parentTabAdd'),
    parentTabRemove: t(locale, 'people.joinWizard.form.parentTabRemove'),
    otherParentFirstName: t(locale, 'people.joinWizard.form.otherParentFirstName'),
    otherParentLastName: t(locale, 'people.joinWizard.form.otherParentLastName'),
    otherParentNationalId: t(locale, 'people.joinWizard.form.otherParentNationalId'),
    otherParentPhone: t(locale, 'people.joinWizard.form.otherParentPhone'),
    otherParentOptional: t(locale, 'people.joinWizard.form.otherParentOptional'),
...
export function step3Copy(locale: Locale) {
  return {
    ...
    methodNotChosen: t(locale, 'people.joinWizard.step3.methodNotChosen'),
    chooseMethodFirst: t(locale, 'people.joinWizard.step3.chooseMethodFirst'),
    methodTrial: t(locale, 'people.joinWizard.step3.methodTrial'),
    methodTrialLong: t(locale, 'people.joinWizard.step3.methodTrialLong'),
    trialNote: t(locale, 'people.joinWizard.step3.trialNote'),
...
export function step4Copy(locale: Locale) {
  return {
    ...
    paymentSettled: t(locale, 'people.joinWizard.step4.paymentSettled'),
    ...
    paymentTrialBooked: t(locale, 'people.joinWizard.step4.paymentTrialBooked'),
    ...
    paymentReasonNoMethod: t(locale, 'people.joinWizard.step4.paymentReasonNoMethod'),
    chipRecorded: t(locale, 'people.joinWizard.step4.chipRecorded'),
    chipSettled: t(locale, 'people.joinWizard.step4.chipSettled'),
