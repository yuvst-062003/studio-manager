...
export function JoinFlow({
  ...
  // individual branches below would have fixed today's symptom and left the same trap for
  // the next step anyone adds; a single wrap point means a step CANNOT be rendered
  // unwrapped.
