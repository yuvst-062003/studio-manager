...
export const reports: Bundle = {
  ...
  'privacy.terms.s2.body':
    'Учётная запись предназначена для опекуна записанного ученика или для совершеннолетнего ученика. Вход выполняется через аккаунт Google; мы не создаём и не храним пароль.',
  ...
  'privacy.terms.s4.body':
    'Цены клуба, а также условия отмены и возврата, изложены в правилах клуба и условиях оплаты, которые вы приняли. Ваши права по израильскому закону о защите прав потребителей действуют в любом случае, и правила клуба их не ограничивают. Запрос на отмену или возврат направляется менеджеру клуба — через контакты на экране профиля. Платежи картой обрабатывает поставщик эквайринга uPay; мы не храним данные карты. Постоянное поручение нельзя оформить через приложение, а полученный так платёж клуб отмечает вручную.',
  ...
  'privacy.policy.s6.body':
    'Поставщику эквайринга uPay — только для проведения платежа; поставщику инфраструктуры и хранения, на котором работает сервис; и выбранному вами поставщику входа, Google, который подтверждает вашу личность. Данные одного клуба недоступны из другого клуба. Никому другому мы данные не передаём без вашего согласия, кроме случаев, когда этого требует закон.',
  ...
  'privacy.gate.staffBody':
    'Как тренер вы видите данные детей и семей — имена, телефоны и наличие медицинской декларации. Принятие здесь — ваше обязательство их беречь.',
  ...
  'byClass.title': 'Доход по классам',
  'byClass.caption': 'Доход и количество учеников по классам за выбранный месяц',
  'byClass.col.class': 'Класс',
  'byClass.col.students': 'Ученики',
  'byClass.col.total': 'Всего',
  'byClass.col.settled': 'Получено',
  'byClass.unassigned': 'Без класса',
  'byClass.total': 'Итого по клубу:',
  'byClass.totalStudents': '{{count}} учеников',
  'byClass.empty': 'В этом месяце нет начислений',
