...
export const comms: Bundle = {
  ...
  'wizard.progress': 'Ход рассылки',
  'wizard.step.kind.title': 'Тип сообщения',
  'wizard.step.kind.subtitle': 'Шаблон или пусто',
  'wizard.step.content.title': 'Содержание',
  'wizard.step.content.subtitle': 'Тема и текст',
  'wizard.step.audience.title': 'Аудитория',
  'wizard.step.audience.subtitle': 'Кто получит',
  'wizard.step.send.title': 'Отправка',
  'wizard.step.send.subtitle': 'Канал и предпросмотр',
  'wizard.kind.lead': 'Начните с шаблона или с чистого листа',
  'wizard.content.lead': 'Что говорит сообщение',
  'wizard.content.tags': 'Вставить личное поле:',
  'wizard.audience.lead': 'Кто получит сообщение',
  'wizard.send.lead': 'Как оно уйдёт и что увидит родитель',
  'wizard.send.noTitle': '(без темы)',
  'wizard.send.noBody': '(без текста)',
  'wizard.send.previewNote': 'Так сообщение выглядит на экране блокировки. Личные поля заменяются настоящим именем при отправке.',
  'channel.push': 'Уведомление в приложении',
  'channel.live': 'Активен',
  'channel.soon': 'Скоро',
