...
export const common: Bundle = {
  ...
  'setup.groups.times': 'Время занятий',
  ...
  'setup.groups.week': 'Получившаяся неделя',
  'setup.groups.weekEmpty': 'Добавьте время занятий, чтобы увидеть неделю',
  'setup.groups.dayEmpty': 'Занятий нет',
  ...
  'setup.groups.timesLater': 'Время задаётся здесь и сохраняется сразу — изменить можно в недельном расписании.',
