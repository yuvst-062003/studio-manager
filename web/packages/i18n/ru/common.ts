...
export const common: Bundle = {
  ...
  'dash.hint.settings': 'Настройки клуба — реквизиты, документы, персонал и переход года',
  ...
  'dash.home.attendanceEmptyAll': 'За последние 30 дней посещаемость ещё не отмечалась',
  ...
  'chips.more': '+{{count}}',
  'chips.moreLabel': 'Ещё {{count}}',
  'table.rowActions': 'Действия',
  'staff.title': 'Персонал',
  'staff.summary': '{n} сотрудников · {h} часов в неделю',
  'staff.stat.people': 'Сотрудники',
  'staff.stat.hours': 'Часов в неделю',
  'staff.stat.coverage': 'Покрытие групп',
  ...
  'staff.rowActions': 'Действия для {{name}}',
  ...
  'stepper.completion': 'Ход мастера',
  'stepper.percent': 'Завершено {{percent}}%',
  'stepper.locked': 'Сначала завершите предыдущие шаги',
  'stepper.state.done': 'Завершён',
  'stepper.state.skipped': 'Пропущен',
  'stepper.state.current': 'Текущий шаг',
  'stepper.state.upcoming': 'Ещё не начат',
  'settings.section.appearance': 'Вид и язык',
  'settings.annual.title': 'Ежегодные действия',
  'settings.annual.hint': 'Два процесса, которые запускаются раз в год, а не каждый день.',
  'settings.annual.setup': 'Мастер настройки',
  'settings.annual.rollover': 'Переход учебного года',
  'settings.users.hint': 'Персонал, роли и права управляются на экране персонала.',
  'settings.users.open': 'Открыть экран персонала',
  'imagePicker.empty': 'Добавить изображение',
  'imagePicker.hint': 'Нажмите, чтобы выбрать файл',
