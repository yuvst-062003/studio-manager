...
export const billing: Bundle = {
  ...
  'cash.manager.title': 'Запросы оплаты наличными',
  'cash.manager.empty': 'Открытых запросов нет.',
  'cash.manager.confirm': 'Наличные получены',
  'cash.manager.decline': 'Не получены',
  'cash.manager.charges': 'счетов',
