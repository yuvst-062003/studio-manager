...
export const health: Bundle = {
  ...
  'clubTerms.entity': 'Brain Building (некоммерческая организация) 580647295',
  'clubTerms.payment.refund':
    'Запрос на отмену абонемента или возврат средств направляется менеджеру клуба — через контакты на экране профиля в приложении. Менеджер обрабатывает запрос и сообщает вам результат. Ваши права по израильскому закону о защите прав потребителей действуют в любом случае, и ничто из указанного выше их не ограничивает.',
  ...
  'onboarding.allMarkedHealthy': '{{count}} вопросов отмечены "нет"',
  'onboarding.allMarkedHealthy.one': '1 вопрос отмечен "нет"',
