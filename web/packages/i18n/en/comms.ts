...
export const comms: Bundle = {
  ...
  'wizard.progress': 'Broadcast progress',
  'wizard.step.kind.title': 'Message type',
  'wizard.step.kind.subtitle': 'Template or blank',
  'wizard.step.content.title': 'Content',
  'wizard.step.content.subtitle': 'Subject and body',
  'wizard.step.audience.title': 'Audience',
  'wizard.step.audience.subtitle': 'Who receives it',
  'wizard.step.send.title': 'Send',
  'wizard.step.send.subtitle': 'Channel and preview',
  'wizard.kind.lead': 'Start from a template, or from a blank page',
  'wizard.content.lead': 'What the message says',
  'wizard.content.tags': 'Insert a personal field:',
  'wizard.audience.lead': 'Who receives the message',
  'wizard.send.lead': 'How it goes out, and what the parent will see',
  'wizard.send.noTitle': '(no subject)',
  'wizard.send.noBody': '(no content)',
  'wizard.send.previewNote': 'This is how the message appears on a lock screen. Personal fields are replaced with the real name when it is sent.',
  'channel.push': 'App notification',
  'channel.live': 'Live',
  'channel.soon': 'Coming soon',
