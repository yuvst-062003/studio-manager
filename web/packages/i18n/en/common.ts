...
export const common: Bundle = {
  ...
  'setup.groups.times': 'Training times',
  ...
  'setup.groups.week': 'The week this creates',
  'setup.groups.weekEmpty': 'Add training times to see the week',
  'setup.groups.dayEmpty': 'No training',
  ...
  'setup.groups.timesLater': 'Times are set here and saved straight away — you can change them on the weekly board.',
