...
export const common: Bundle = {
  ...
  'tabs.staffBarLabel': 'main navigation',
  'tabs.staffSchedule': 'Schedule',
  'tabs.staffStudents': 'Students',
  'tabs.staffTimer': 'Timer',
  'tabs.staffTasks': 'Tasks',
  'tabs.staffAccount': 'Account',
  // §6.1's first run.
  'language.button': 'Choose language',
  'language.short.he': 'עב',
  'language.short.en': 'EN',
  'language.short.ru': 'RU',
  'language.title': 'language',
  'language.gate.welcome': 'Welcome',
  'language.gate.choose': 'Choose a language',
  'language.gate.continue': 'Continue',
  'language.gate.later': 'You can change this later in settings',
  // -- the parent app's sign-in face (owner's Stitch design, 2026-09-01) ---------
  'auth.parentHint': 'Sign in with Google to reach the training schedule, belts and competitions.',
  ...
  'auth.dashboard.title': 'Sign in to Gladiator',
  'auth.dashboard.blurb': 'Access your dojo portal, schedules and training history.',
  'auth.dashboard.copyright': '© 2026 Gladiator Judo Club. All rights reserved.',
...
'setup.skipForNow': 'Skip for now',
  ...
  'dash.home.attendanceEmptyAll': 'No attendance has been marked in the last 30 days yet',
  ...
  'chips.more': '+{{count}}',
  'chips.moreLabel': '{{count}} more',
  'table.rowActions': 'Actions',
  'staff.title': 'Staff',
  'staff.summary': '{n} staff · {h} weekly hours',
  'staff.stat.people': 'Staff',
  'staff.stat.hours': 'Weekly hours',
  'staff.stat.coverage': 'Group coverage',
  ...
  'staff.rowActions': 'Actions for {{name}}',
  'staff.count': '{n} staff',
  ...
  'dash.home.money.debtAction': 'Chase payment',
  'dash.home.money.collectedAction': 'Payment detail',
  'dash.home.money.households': '{{count}} families',
  'dash.home.today.when.past': 'Finished',
  'dash.home.today.when.live': 'On the mat now',
  'dash.home.today.when.soon': 'Coming up',
  ...
  'account.title': 'Account and settings',
  'account.group.club': 'Club management',
  ...
  'settings.annual.title': 'Once-a-year actions',
  'settings.annual.hint': 'Two flows that run once a year, not every day.',
  'settings.annual.setup': 'Setup wizard',
  'settings.annual.rollover': 'Training-year rollover',
  'settings.users.hint': 'Staff, roles and permissions are managed on the staff screen.',
  'settings.users.open': 'Open the staff screen',
  'imagePicker.empty': 'Add an image',
  'imagePicker.hint': 'Press to choose a file',
