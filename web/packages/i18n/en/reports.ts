...
export const reports: Bundle = {
  ...
  'byClass.title': 'Revenue by class',
  'byClass.caption': 'Revenue and enrolment per class for the selected month',
  'byClass.col.class': 'Class',
  'byClass.col.students': 'Students',
  'byClass.col.total': 'Total',
  'byClass.col.settled': 'Collected',
  'byClass.unassigned': 'No class',
  'byClass.total': 'Club total:',
  'byClass.totalStudents': '{{count}} students',
  'byClass.empty': 'No charges in this month',
