...
export const billing: Bundle = {
  ...
  // ── Per-class prices (2026-09-09) ────────────────────────────────────────────
  'classPrices.title': 'Prices by class',
  'classPrices.hint': 'Each class this student trains in can have its own plan. A child in two classes pays for both.',
  'classPrices.none': 'No specific price',
  'classPrices.fallbackNote': 'Charged at the general plan — {{amount}}',
  'classPrices.noFallback': 'No general plan set — this student is not charged for this class',
  'classPrices.generalPlan': 'General plan',
  'classPrices.empty': 'This student is not enrolled in any active class',
  'classPrices.save': 'Save prices',
  'classPrices.saving': 'Saving…',
  'classPrices.saved': 'Prices saved',
  'classPrices.saveFailed': 'Saving failed. Try again.',
  'classPrices.loadFailed': 'We could not load the prices',
  'classPrices.planFor': 'Plan for {{class}}',
  // ── Class headings and the unfiled warning (2026-09-09) ──────────────────────
  'byClass.unfiled': 'No class',
  'byClass.unfiledItems': 'No parent can see these items in the shop. Give each one a class.',
  'byClass.unfiledPlans': 'These plans cannot be given to any student. Give each one a class.',
  'byClass.fileHere': 'Assign to a class',
  'byClass.filing': 'Assigning…',
  'byClass.fileFailed': 'Assigning failed. Try again.',
  'byClass.wizardProgress': 'Class {{n}} of {{total}}',
  'byClass.wizardNext': 'Next class',
  'byClass.wizardNoClasses': 'No classes yet. Go back to the groups step.',
  'plan.perMonth': 'per month',
  'plan.class': 'Class',
  'plan.classAll': 'All classes',
  'plan.classChoose': 'Choose a class',
  'plan.classHint': 'Prices this class only. A child in two classes pays for both.',
  ...
  'product.class': 'Class',
  'product.classUnset': 'Choose a class',
  'product.classMissing': 'No class — not shown to parents',
