...
export const billing: Bundle = {
  ...
  'cash.manager.title': 'Cash payment requests',
  'cash.manager.empty': 'No open cash requests.',
  'cash.manager.confirm': 'Cash received',
  'cash.manager.decline': 'Not received',
  'cash.manager.charges': 'charges',
