...
export const health: Bundle = {
  ...
  "declaration.intro":
    "Answer the questions and sign at the bottom of the form",
  "declaration.yes": "Yes",
  "declaration.no": "No",
  ...
  "badge.missingHint":
    "You can still mark attendance. The declaration is owed by the guardian",
  ...
  "documents.viewFullNotice":
    "Viewing a declaration is recorded in the audit log",
  ...
  "template.flagQuestionHint":
    "A boolean marker only. The answer itself is never shown to a coach",
