...
export const schedule: Bundle = {
  ...
  'classes.colour': 'צבע החוג',
  'classes.colourNone': 'ללא צבע',
  'classes.colour.emphasis': 'ירוק',
  'classes.colour.debt': 'אדום',
  'classes.colour.paid': 'ירוק בהיר',
  'classes.colour.pending': 'כתום',
  'classes.colour.cancelled': 'אפור',
  'classes.save': 'שמירה',
