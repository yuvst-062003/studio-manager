...
export const schedule: Bundle = {
  ...
  // -- `#/classes` — חוגים. Checkpoint 6, second pass: classes are what you open to
  // find groups, and the club's structure reads class-then-group the way it is stored.
  'classes.title': 'חוגים',
  'classes.subtitle': 'החוגים של המועדון. פתחו חוג כדי לראות את הקבוצות שלו',
  'classes.empty': 'לא הוגדרו חוגים',
  'classes.create': 'חוג חדש',
  'classes.createTitle': 'חוג חדש',
  'classes.editTitle': 'עריכת החוג',
  'classes.edit': 'עריכת פרטי החוג',
  'classes.retire': 'העברה לארכיון',
  'classes.revive': 'החזרה מהארכיון',
  'classes.rowActions': 'פעולות עבור {{name}}',
  'classes.name': 'שם החוג',
  'classes.description': 'תיאור',
  'classes.save': 'שמירה',
  'classes.saveFailed': 'לא הצלחנו לשמור את החוג. נסו שוב.',
  'classes.groupCount': '{{count}} קבוצות',
  'classes.groupCountOne': 'קבוצה אחת',
  'classes.openGroups': 'הקבוצות של החוג',
  'classes.backToClasses': 'חזרה לחוגים',
  // -- §3.21's class wizard. The ONLY way a class is created or edited. ---------------
  'wizard.createTitle': 'הקמת חוג חדש',
  'wizard.createSubtitle': 'שבעה שלבים — כל שלב נשמר בפני עצמו, אפשר לצאת ולחזור',
  'wizard.editTitle': 'עריכת חוג',
  'wizard.editSubtitle': 'אותם שבעה שלבים, פתוחים על מה שכבר קיים',
  'wizard.progress': 'התקדמות באשף',
  'wizard.stepOf': 'שלב {{n}} מתוך {{total}}',
  'wizard.exit': 'סיום ויציאה',
  'wizard.next': 'המשך',
  'wizard.saveAndNext': 'שמירה והמשך',
  'wizard.createAndNext': 'יצירת החוג והמשך',
  'wizard.skipAndNext': 'דילוג והמשך',
  'wizard.finish': 'סיום',
  'wizard.needsClass': 'יש להשלים את שלב פרטי החוג תחילה',
  'wizard.step.details.title': 'פרטי החוג',
  'wizard.step.details.subtitle': 'שם ותיאור',
  'wizard.step.groups.title': 'קבוצות ולו״ז',
  'wizard.step.groups.subtitle': 'ימים ושעות',
  'wizard.step.prices.title': 'תמחור',
  'wizard.step.prices.subtitle': 'מסלולי תשלום',
  'wizard.step.belts.title': 'דרגות',
  'wizard.step.belts.subtitle': 'סולם חגורות',
  'wizard.step.items.title': 'ציוד',
  'wizard.step.items.subtitle': 'פריטים למכירה',
  'wizard.step.coaches.title': 'מאמנים',
  'wizard.step.coaches.subtitle': 'שיבוץ לקבוצות',
  'wizard.step.launch.title': 'הרשמה',
  'wizard.step.launch.subtitle': 'קישור והשקה',
  'wizard.details.lead': 'איך קוראים לחוג, ומה הוא',
  'wizard.details.discipline': 'ענף',
  'wizard.details.disciplineHint': 'לדוגמה: ג׳ודו. משמש לסינון ולתצוגה',
  'wizard.groups.lead': 'הקבוצות של החוג, והימים והשעות של כל אחת',
  'wizard.groups.empty': 'עדיין אין קבוצות בחוג הזה',
  'wizard.groups.addTitle': 'הוספת קבוצה',
  'wizard.groups.ageMin': 'גיל מינימלי',
  'wizard.groups.ageFrom': 'מגיל {{n}}',
  'wizard.groups.ageTo': 'עד גיל {{n}}',
  'wizard.groups.ageMax': 'גיל מקסימלי',
  'wizard.groups.createFailed': 'לא הצלחנו ליצור את הקבוצה. נסו שוב.',
  'wizard.groups.scheduleFailed': 'לא הצלחנו לשמור את הלו״ז. נסו שוב.',
  'wizard.groups.hasSchedule': 'לקבוצה הזו כבר יש לו״ז. שינוי לו״ז קיים משפיע על שיעורים שכבר נוצרו, ולכן נעשה בעמוד הקבוצה עם תצוגת ההשפעה.',
  'wizard.groups.openGroup': 'פתיחת עמוד הקבוצה',
  'wizard.prices.lead': 'המסלולים שהחוג הזה מתומחר לפיהם',
  'wizard.prices.empty': 'עדיין לא הוגדרו מסלולים לחוג הזה',
  'wizard.prices.addTitle': 'הוספת מסלול',
  'wizard.prices.name': 'שם המסלול',
  'wizard.prices.perWeek': 'אימונים בשבוע',
  'wizard.prices.perWeekHint': 'השאירו ריק למסלול ללא הגבלה',
  'wizard.prices.monthly': 'מחיר חודשי (₪)',
  'wizard.prices.registration': 'דמי הרשמה (₪)',
  'wizard.prices.add': 'הוספה',
  'wizard.prices.unlimited': 'ללא הגבלה',
  'wizard.prices.failed': 'לא הצלחנו ליצור את המסלול. נסו שוב.',
  'wizard.prices.standingOrderNote': 'הוראת קבע אינה נוצרת מכאן — הספק שלנו לא מאפשר זאת. מה שנשמר הוא קישור לעמוד של הספק, ומקומו בהגדרות ← תשלומים.',
  'wizard.belts.lead': 'סולם החגורות של החוג הזה',
  'wizard.belts.empty': 'עדיין לא הוגדר סולם חגורות',
  'wizard.belts.seedFailed': 'לא הצלחנו ליצור את סולם החגורות. נסו שוב.',
  'wizard.belts.editElsewhere': 'שינוי שמות וסדר נעשה במסך החגורות.',
  'wizard.belts.openLadder': 'פתיחת מסך החגורות',
  'wizard.items.lead': 'הפריטים שהחוג הזה מוכר',
  'wizard.items.empty': 'עדיין לא הוגדרו פריטים לחוג הזה',
  'wizard.items.addTitle': 'הוספת פריט',
  'wizard.items.name': 'שם הפריט',
  'wizard.items.price': 'מחיר (₪)',
  'wizard.items.sizes': 'מידות',
  'wizard.items.sizesHint': 'מופרדות בפסיק. ריק — לפריט אין מידות',
  'wizard.items.noSizes': 'ללא מידות',
  'wizard.items.add': 'הוספה',
  'wizard.items.failed': 'לא הצלחנו ליצור את הפריט. נסו שוב.',
  'wizard.coaches.lead': 'מי מאמן כל קבוצה בחוג',
  'wizard.coaches.noGroups': 'אין קבוצות לשבץ אליהן. חזרו לשלב הקבוצות.',
  'wizard.coaches.person': 'איש צוות',
  'wizard.coaches.roleLabel': 'תפקיד',
  'wizard.coaches.role.lead_coach': 'מאמן ראשי',
  'wizard.coaches.role.assistant_coach': 'מאמן משנה',
  'wizard.coaches.assign': 'שיבוץ',
  'wizard.coaches.uncovered': 'ללא מאמן',
  'wizard.coaches.failed': 'לא הצלחנו לשבץ. נסו שוב.',
  'wizard.coaches.permissionsNote': 'ההרשאות נגזרות מהתפקיד: מאמן רואה את הקבוצות שהוא מאמן ומסמן בהן נוכחות. אין כאן מתגי הרשאה נפרדים, ואין שכר — המערכת לא מנהלת שכר.',
  'wizard.launch.lead': 'מה מוכן, ואיך משפחות נרשמות',
  'wizard.launch.readiness': 'מצב',
  'wizard.launch.ready': 'מוכן לרישום',
  'wizard.launch.notReady': 'חסרות קבוצות',
  'wizard.launch.healthGate': 'הצהרת בריאות חתומה נדרשת מכל חניך — זו לא הגדרה שאפשר לכבות. ללא הצהרה חתומה המשפחה לא מגיעה לשום מסך אחר.',
  'wizard.launch.linkTitle': 'קישור ההרשמה',
  'wizard.launch.linkScope': 'הקישור הוא של המועדון כולו ולא של חוג בודד — הבחירה באיזה חוג נעשית בתוך תהליך ההרשמה.',
  'wizard.launch.createLink': 'יצירת קישור',
  'wizard.launch.linkFailed': 'לא הצלחנו ליצור קישור. נסו שוב.',
  ...
  'groups.active': 'פעילה',
  'groups.nextCoachRoom': 'מאמן ואולם בשיעור הבא',
