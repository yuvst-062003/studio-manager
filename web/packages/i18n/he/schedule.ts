...
export const schedule: Bundle = {
  ...
  'setup.method': 'אמצעי תשלום',
  'setup.change': 'שינוי',
  'setup.total': 'סה״כ לתשלום בכרטיס',
  'setup.payCard': 'לתשלום בכרטיס',
  'setup.handSent': 'הודענו למנהל. הוא יסמן כשהכסף יגיע.',
  'setup.standingTitle': 'הוראת קבע — קישור לכל ילד',
  'setup.standingHint': 'לכל ילד קישור נפרד, כי הוראת קבע נחתמת על סכום קבוע.',
  'setup.linkFor': 'הקמת הוראת קבע עבור {name}',
  'setup.finish': 'סיום',
  'setup.nothingToPay': 'אין תשלומים פתוחים.',
