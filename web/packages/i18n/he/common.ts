...
export const common: Bundle = {
  ...
  'a11y.scale.112': 'גדול',
  'a11y.scale.125': 'גדול מאוד',
  'a11y.contrast': 'ניגודיות גבוהה',
  'a11y.motion': 'הפחתת אנימציות',
  ...
  'dash.hint.comms': 'שליחת הודעות למשפחות וצפייה במה שנשלח',
  'dash.hint.students': 'כל החניכים — כרטיס אישי, סטטוס ומסמכים',
  'dash.hint.groups': 'קבוצות ומחזורים — הרכב, לו״ז ושיוך חניכים',
  'dash.hint.events': 'אירועים, תחרויות ומבחני חגורה — יצירה ורישום',
  'dash.hint.belts': 'סולם החגורות, מבחנים והענקות',
  'dash.hint.staff': 'צוות המועדון — הזמנות, תפקידים והרשאות',
  'dash.hint.rollover': 'מעבר שנה — סגירת שנה ופתיחת החדשה',
  'dash.hint.billing': 'גבייה — חובות לפי משפחה, תשלומים ותזכורות',
  'dash.hint.prices': 'מסלולי מחיר ומנויים — יצירה ועדכון',
