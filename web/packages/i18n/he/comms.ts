...
export const comms: Bundle = {
  ...
  'wizard.progress': 'התקדמות בשליחה',
  'wizard.step.kind.title': 'סוג ההודעה',
  'wizard.step.kind.subtitle': 'תבנית או ריק',
  'wizard.step.content.title': 'תוכן',
  'wizard.step.content.subtitle': 'נושא וגוף',
  'wizard.step.audience.title': 'קהל יעד',
  'wizard.step.audience.subtitle': 'מי מקבל',
  'wizard.step.send.title': 'שליחה',
  'wizard.step.send.subtitle': 'ערוץ ותצוגה',
  'wizard.kind.lead': 'התחילו מתבנית, או מדף ריק',
  'wizard.content.lead': 'מה ההודעה אומרת',
  'wizard.content.tags': 'הוספת שדה אישי:',
  'wizard.audience.lead': 'מי מקבל את ההודעה',
  'wizard.send.lead': 'איך זה נשלח, ומה ההורה יראה',
  'wizard.send.noTitle': '(ללא נושא)',
  'wizard.send.noBody': '(ללא תוכן)',
  'wizard.send.previewNote': 'כך ההודעה תיראה במסך הנעילה. שדות אישיים מוחלפים בשם האמיתי בעת השליחה.',
