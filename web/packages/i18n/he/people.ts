...
export const people: Bundle = {
  ...
  'import.lead.done': 'הייבוא הסתיים. ההזמנות יצאו במייל וכל משפחה ממשיכה מכאן בעצמה.',
  ...
  'import.how2Note': 'רק שם פרטי ואימייל חובה — כל השאר אפשר להשלים אחר כך. עומדים על תא — רואים הסבר.',
  ...
  'import.col.email': 'של ההורה. לבוגר — שלו. אחים: אותו אימייל בכל שורה = משפחה אחת, הזמנה אחת.',
  ...
  'import.stat.invited': 'הזמנות נשלחו',
  'import.stat.mailFailed': 'מייל לא יצא',
  ...
  'import.family.invitation': 'הזמנה אחת',
  ...
  'import.problem.missing_email': 'חסר אימייל — בלי אימייל אין חשבון',
  ...
  'import.footer.hint': 'הייבוא יוצר את החניכים, מצרף לקבוצות ושולח לכל משפחה הזמנה במייל. שורות שלא תוקנו נשארות כאן.',
  ...
  'import.done.sent': 'ההזמנה נשלחה במייל ל־{{n}} משפחות',
  'import.done.notNeeded': '{{n}} כבר עם חשבון',
  'import.done.mailFailed': '{{n}} מיילים לא יצאו — אפשר לשלוח שוב מהשורה',
  'import.done.unconfigured': 'שליחת מייל לא מוגדרת במועדון — ההזמנות לא נשלחו',
  'import.done.left': '{{n}} שורות נשארו לתיקון',
  'import.done.note': 'כל משפחה ממשיכה בעצמה מהמייל: פרטים, הצהרת בריאות ותשלום — בדיוק כמו כל הצטרפות. אין מה לשלוח ידנית.',
  'import.done.finish': 'סיום — לרשימת החניכים',
  'import.done.again': 'ייבוא קובץ נוסף',
  'import.done.runLeft': 'ייבוא {{n}} הנותרים',
  'import.invite.sent': 'הזמנה נשלחה במייל',
  'import.invite.not_needed': 'לא נדרשה — כבר יש חשבון',
  'import.invite.unconfigured': 'לא נשלחה — מייל לא מוגדר',
  'import.invite.failed': 'המייל לא יצא',
  'import.invite.none': 'לא יובא',
  'import.invite.resend': 'שליחה חוזרת',
  'import.invite.resent': 'נשלח שוב',
  'import.invite.resendFailed': 'השליחה נכשלה שוב',
  ...
  'import.tpl.prompt.email': 'האימייל של ההורה; לבוגר — שלו. אחים: אותו אימייל בכל שורה. חובה.',
