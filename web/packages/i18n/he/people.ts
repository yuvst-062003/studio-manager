...
export const people: Bundle = {
  ...
  'convert.paymentReceived': 'התשלום כבר התקבל',
  'convert.paymentReceivedNone': 'עדיין לא',
  'convert.methodCash': 'מזומן',
  'convert.methodCheque': 'צ׳קים',
  'convert.methodStandingOrder': 'הוראת קבע',
  'convert.paymentReceivedHint': 'נרשם על שם המועדון, וההורה לא יישאל שוב על אמצעי תשלום באפליקציה.',
  'convert.paymentReceivedCardNote': 'תשלום באשראי נסגר לבד דרך הקישור של האפליקציה — אין מה לסמן כאן.',

  // §5.4(a) — הוספת חניכים, the family roster screen.
  'addStudents.title': 'הוספת חניכים',
  'addStudents.lead': 'מלאו את מה שאתם יודעים — כל השאר נשאל מהמשתמש עצמו באשף ההצטרפות.',
  'addStudents.stepOf': 'שלב {n} מתוך 2',
  'addStudents.step1': 'פרטי החניכים',
  'addStudents.step1Note': 'שם, גיל, קבוצה ומסלול',
  'addStudents.step2': 'סיכום ויצירה',
  'addStudents.step2Note': 'בדיקה אחרונה והנפקת קישורים',
  'addStudents.rosterTitle': 'חניכים',
  'addStudents.rosterHint': 'ניתן לערוך או להסיר חניך לפני המעבר לסיכום',
  'addStudents.rosterEmpty': 'עדיין לא הוספתם אף חניך.',
  'addStudents.addTrainee': 'הוספת חניך למשפחה',
  'addStudents.age': 'גיל',
  'addStudents.ageHint': 'הגיל קובע לבד מי קטין ומי בוגר. תאריך הלידה המדויק מאושר על ידי המשתמש עצמו באשף.',
  'addStudents.adult': 'בוגר',
  'addStudents.emailParent': 'אימייל ההורה',
  'addStudents.emailSelf': 'אימייל המתאמן',
  'addStudents.emailParentHint': 'האימייל מזהה הורה שכבר קיים במועדון ומחבר אליו אחים, במקום ליצור הורה שני.',
  'addStudents.emailSelfHint': 'בן 18 ומעלה נרשם בעצמו — הוא נכנס עם החשבון שלו וחותם על ההצהרה בעצמו.',
  'addStudents.belt': 'חגורה',
  'addStudents.beltNone': 'טרם נקבעה',
  'addStudents.beltNeedsGroup': 'סולם החגורות שייך לחוג — בחרו קבוצה כדי לבחור חגורה.',
  'addStudents.beltNote': 'נרשם בעת ההוספה למועדון',
  'addStudents.noGroup': 'טרם שויך',
  'addStudents.planNeedsGroup': 'בחרו קבוצה כדי לקבוע מסלול ותשלום.',
  'addStudents.awaitingPayment': 'ממתין להסדר תשלום',
  'addStudents.viaParent': 'דרך ההורה:',
  'addStudents.viaSelf': 'נכנס בעצמו:',
  'addStudents.wizardSteps': 'האשף שלו: {n} שלבים',
  'addStudents.accountRule': 'לכל חניך יש חשבון אחד שנכנס בשבילו: של ההורה כל עוד הוא קטין, ושלו עצמו מגיל 18. אחים חולקים אימייל — הוא ממולא מראש.',
  'addStudents.footerCounts': '{links} קישורים · {trainees} חניכים',
  'addStudents.continueToReview': 'המשך לסיכום',
  'addStudents.backToEdit': 'חזרה לעריכה',
  'addStudents.create': 'יצירה והנפקת קישורים',
  'addStudents.parentRole': 'הורה',
  'addStudents.adultRole': 'מתאמן בוגר',
  'addStudents.oneLink': 'קישור אחד',
  'addStudents.outcomeTitle': 'מה יקרה כשתאשרו',
  'addStudents.outcomeCreated': 'ייווצרו {n} חניכים.',
  'addStudents.outcomeLinks': 'יונפקו {n} קישורי הצטרפות — אתם מעבירים אותם.',
  'addStudents.outcomeSettled': '{n} מהם סומנו כשולמו וידלגו על שלב התשלום באשף.',
  'addStudents.outcomeAllPay': 'כל החניכים יעברו את שלב התשלום באשף.',
  'addStudents.doneTitle': 'נוצרו {n} חניכים',
  'addStudents.doneNote': 'כל כתובת מקבלת קישור משלה. מי שנכנס איתו מגיע ישירות לחניכים שמאחוריו.',
  'addStudents.partial': 'לא הכול נקלט: {names}. בדקו אותם בכרטיס החניך.',
  'addStudents.addAnother': 'הוספת משפחה נוספת',
  'addStudents.sheetAdd': 'הוספת חניך',
  'addStudents.sheetEdit': 'עריכת חניך',
  'addStudents.cancel': 'ביטול',
  'addStudents.save': 'שמירה',
  'addStudents.edit': 'עריכה',
  'addStudents.remove': 'הסרה',
  ...
  'joinWizard.header.stepWord': 'שלב',
  'joinWizard.header.ofWord': 'מתוך',
  'joinWizard.header.stageName.1': 'הסכמים ותקנון',
  'joinWizard.header.stageName.2': 'פרטי מתאמנים',
  'joinWizard.header.stageName.3': 'תשלום וסיכום',
  'joinWizard.header.stageName.4': 'הרישום הושלם בהצלחה',
  ...
  'joinWizard.step3.methodNotChosen': 'טרם נבחר אופן תשלום',
  'joinWizard.step3.chooseMethodFirst': 'בחרו אופן תשלום לכל מתאמן',
  ...
  'joinWizard.step4.paymentSettled': 'התשלום כבר סודר מול המועדון',
  ...
  'joinWizard.step4.paymentReasonNoMethod': 'לא נבחר אופן תשלום. המועדון ייצור קשר להשלמת הפרטים',
  'joinWizard.step4.chipRecorded': 'אופן התשלום נרשם',
  'joinWizard.step4.chipSettled': 'התשלום סודר',
