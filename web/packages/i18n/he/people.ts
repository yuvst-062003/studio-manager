...
export const people: Bundle = {
  ...
  'import.how2Note': 'רק שם פרטי ודרך ליצור קשר — אימייל או טלפון — חובה. כל השאר אפשר להשלים אחר כך. עומדים על תא — רואים הסבר.',
  ...
  'import.columns.summary': '11 עמודות · שם פרטי חובה, ואימייל או טלפון · 4 עמודות בחירה בלבד — אקסל לא מקבל בהן ערך שלא ברשימה',
  ...
  'import.col.group': 'רק מהרשימה — הקבוצות של המועדון. ריק = עדיין בלי קבוצה.',
  'import.col.belt': 'רק מהרשימה — הסולם של המועדון.',
  'import.col.plan': 'רק מהרשימה — מסלולי המחיר הפעילים. ריק = ייקבע אחר כך.',
  ...
  'import.error.bad_header': 'לא מצאנו את העמודות ״שם פרטי״ ו״אימייל״ בשורה הראשונה. התחילו מהתבנית.',
  ...
  'import.tpl.prompt.group': 'בחרו מהרשימה. ריק = עדיין בלי קבוצה.',
  'import.tpl.prompt.belt': 'בחרו מהרשימה — החגורה שהחניך כבר מחזיק.',
  'import.tpl.prompt.plan': 'בחרו מהרשימה. ריק = ייקבע אחר כך.',
