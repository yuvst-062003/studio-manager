...
export const people: Bundle = {
  ...
  'import.how2Note': 'חובה: שם פרטי, אימייל או טלפון, קבוצה ומסלול. כל השאר אפשר להשלים אחר כך. עומדים על תא — רואים הסבר.',
  ...
  'import.columns.summary': '11 עמודות · חובה: שם פרטי, קבוצה, מסלול, ואימייל או טלפון · 4 עמודות בחירה בלבד — אקסל לא מקבל בהן ערך שלא ברשימה',
  ...
  'import.col.payment': 'רק מהרשימה: מזומן / צ׳קים / הוראת קבע — אם המשפחה כבר שילמה. ריק = עדיין לא.',
  ...
  'import.error.bad_header': 'חסרות עמודות חובה בשורה הראשונה — שם פרטי, אימייל, קבוצה ומסלול. התחילו מהתבנית.',
  ...
  'import.problem.bad_payment': 'הסדר תשלום לא מוכר — מזומן, צ׳קים או הוראת קבע',
  'import.problem.card_payment': 'אשראי לא נרשם כאן — התשלום בכרטיס נסגר לבד דרך האפליקציה. השאירו ריק',
  ...
  'import.tpl.prompt.payment': 'בחרו מהרשימה אם המשפחה כבר שילמה. ריק = עדיין לא.',
