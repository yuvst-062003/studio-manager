...
export const people: Bundle = {
  ...
  'invite.filter': 'הזמנה',
  'invite.any': 'כל המשפחות',
  'invite.ready': 'ממתינות להזמנה',
  'invite.no_email': 'חסר אימייל',
  'invite.signed_in': 'כבר נכנסו לאפליקציה',
  ...
  'bulk.invite': 'שליחת הזמנות',
  'bulk.inviteConfirm': 'לשלוח הזמנה למשפחות שנבחרו? מי שאפשר לפנות אליה תקבל מייל עם קישור להצטרפות. משפחה שכבר נכנסה לאפליקציה, או שאין לה אימייל, תדולג ותופיע ברשימה.',
  ...
  'bulk.refused.not_invitable': 'אין למי לשלוח — כבר יש חשבון, או שאין אימייל',
  ...
  'import.title': 'ייבוא חניכים מקובץ',
  'import.entry': 'ייבוא מקובץ',
  'import.stepOf': 'שלב {{n}} מתוך {{total}}',
  'import.step1': 'הקובץ',
  'import.step1Note': 'הורדת תבנית והעלאה',
  'import.step2': 'בדיקה וייבוא',
  'import.step2Note': 'עוברים על הטבלה, מתקנים, ולוחצים ייבוא',
  'import.lead.file': 'העלו קובץ אקסל של כל המשפחות — בודקים אותו לפני שנוצר משהו.',
  'import.lead.review': 'כל שורה מהקובץ, מקובצת למשפחה. מתקנים כאן מה שצריך — ואז ייבוא.',
  'import.lead.done': 'הייבוא הסתיים. לא נשלח שום מייל — ההזמנות מוכנות וממתינות לרגע שתבחרו.',
  'import.back': 'חזרה לרשימת החניכים',
  'import.how1': 'הורידו את התבנית',
  'import.how1Note': 'גיליון אחד, מוכן לכתיבה. בעמודות הבחירה אקסל מקבל רק ערך מהרשימה שלכם.',
  'import.how2': 'מלאו שורה לכל חניך',
  'import.how2Note': 'חובה: שם פרטי, אימייל או טלפון, קבוצה, מסלול והסדר תשלום. כל השאר אפשר להשלים אחר כך. עומדים על תא — רואים הסבר.',
  'import.how3': 'העלו את הקובץ כאן',
  'import.how3Note': 'בשלב הבא בודקים כל שורה. שום דבר לא נוצר לפני שאישרתם.',
  'import.template.title': 'התבנית',
  'import.template.hint': 'גיליון אחד. פותחים באקסל, ממלאים, שומרים.',
  'import.template.lists': 'בעמודות קבוצה, חגורה, מסלול והסדר תשלום — בחירה בלבד.',
  'import.template.listsNote': 'רשימה נפתחת עם מה שיש במועדון היום; ערך אחר אקסל לא מקבל.',
  'import.template.date': 'תאריך לידה',
  'import.template.dateNote': 'תא תאריך. אקסל דוחה מה שאינו תאריך.',
  'import.template.help': 'הסבר בתוך אקסל.',
  'import.template.helpNote': 'עומדים על תא — קופץ הסבר קצר מה כותבים בו. בלי גיליונות נוספים.',
  'import.template.download': 'הורדת התבנית (Excel)',
  'import.template.downloading': 'מכינים את התבנית…',
  'import.template.fileName': 'תבנית-חניכים.xlsx',
  'import.template.sheet': 'חניכים',
  'import.upload.title': 'הקובץ המלא',
  'import.upload.hint': 'אחרי שמילאתם — מעלים כאן.',
  'import.upload.drop': 'גררו לכאן את הקובץ',
  'import.upload.or': 'או',
  'import.upload.pick': 'בחירת קובץ מהמחשב',
  'import.upload.formats': '.xlsx · .csv · עד 500 שורות',
  'import.upload.reading': 'קוראים את הקובץ…',
  'import.columns.title': 'מה כותבים בכל עמודה',
  'import.columns.summary': '11 עמודות · חובה: שם פרטי, קבוצה, מסלול, הסדר תשלום, ואימייל או טלפון · 4 עמודות בחירה בלבד — אקסל לא מקבל בהן ערך שלא ברשימה',
  'import.columns.column': 'עמודה',
  'import.columns.required': 'חובה?',
  'import.columns.kind': 'איך ממלאים',
  'import.columns.what': 'מה כותבים',
  'import.columns.example': 'דוגמה',
  'import.columns.yes': 'חובה',
  'import.columns.no': 'רשות',
  'import.columns.either': 'אימייל או טלפון',
  'import.kind.text': 'טקסט חופשי',
  'import.kind.date': 'תאריך',
  'import.kind.list': 'בחירה בלבד',
  'import.col.first_name': 'השם הפרטי של החניך/ה.',
  'import.col.last_name': 'מומלץ למלא.',
  'import.col.birthdate': 'יום/חודש/שנה — התא מעוצב כתאריך.',
  'import.col.parent_first': 'ריק = החניך בוגר (18+) עם חשבון משלו.',
  'import.col.parent_last': 'שם המשפחה של ההורה.',
  'import.col.email': 'של ההורה. לבוגר — שלו. אחים: אותו אימייל (או אותו טלפון) בכל שורה = משפחה אחת, הזמנה אחת. אפשר להשאיר ריק אם יש טלפון.',
  'import.col.phone': 'נשמר בכרטיס. לא נשלחות הודעות.',
  'import.col.group': 'רק מהרשימה — הקבוצות של המועדון. חובה: בלי קבוצה החניך לא משובץ ולא מופיע באף מסך נוכחות.',
  'import.col.belt': 'רק מהרשימה — הסולם של המועדון.',
  'import.col.plan': 'רק מהרשימה — מסלולי המחיר הפעילים. חובה: בלי מסלול אין מחיר ואין חיוב, והמשפחה לא מופיעה בגבייה.',
  'import.col.payment': 'רק מהרשימה. חובה: איך המשפחה כבר שילמה — מזומן / צ׳קים / הוראת קבע — או ״עדיין לא שילמו״. אשראי נסגר לבד דרך האפליקציה ולא נרשם כאן.',
  'import.example.title': 'כך נראה קובץ מלא',
  'import.example.note': 'שורות 2–3: אחים · שורה 4: בוגר, בלי הורה · שורה 5: רק שם ואימייל · ▾ = בחירה מרשימה בלבד',
  'import.example.sheet': 'גיליון',
  'import.error.empty': 'הקובץ ריק — אין בו שורות מתחת לכותרות.',
  'import.error.bad_header': 'חסרות עמודות חובה בשורה הראשונה — שם פרטי, אימייל, קבוצה, מסלול והסדר תשלום. התחילו מהתבנית.',
  'import.error.unreadable': 'לא הצלחנו לקרוא את הקובץ. שמרו אותו מאקסל כ־.xlsx ונסו שוב.',
  'import.error.too_many_rows': 'יותר מ־500 שורות. פצלו לשני קבצים.',
  'import.error.unsupported': 'סוג קובץ לא נתמך — .xlsx או .csv בלבד.',
  'import.file.rows': '{{n}} שורות',
  'import.file.replace': 'החלפת קובץ',
  'import.stat.families': 'משפחות',
  'import.stat.trainees': 'חניכים',
  'import.stat.ready': 'מוכנים לייבוא',
  'import.stat.problems': 'לתיקון',
  'import.stat.added': 'חניכים נוספו',
  'import.stat.held': 'הזמנות ממתינות',
  'import.filter.all': 'הכול',
  'import.filter.problems': 'לתיקון',
  'import.review.hint': 'כל תא ניתן לעריכה כאן — לא צריך לחזור לקובץ. שורה עם בעיה לא תיובא עד שתתוקן או תימחק.',
  'import.family.named': 'משפחת {{name}}',
  'import.family.noParent': 'ללא שם הורה',
  'import.family.noEmail': 'ללא אימייל',
  'import.family.adult': 'בוגר · חשבון משלו',
  'import.family.one': 'חניך אחד',
  'import.family.many': '{{n}} חניכים',
  'import.family.invitation': 'הזמנה תיווצר — לא תישלח',
  'import.family.edit': 'עריכת פרטי ההורה',
  'import.family.editDone': 'סיום עריכה',
  'import.family.parentFirst': 'שם פרטי ההורה',
  'import.family.parentLast': 'שם משפחה ההורה',
  'import.family.email': 'אימייל',
  'import.family.phone': 'טלפון',
  'import.th.trainee': 'חניך',
  'import.th.firstName': 'שם פרטי',
  'import.th.lastName': 'שם משפחה',
  'import.th.birthdate': 'תאריך לידה',
  'import.th.group': 'קבוצה',
  'import.th.belt': 'חגורה',
  'import.th.plan': 'מסלול',
  'import.th.payment': 'הסדר תשלום מראש',
  'import.th.state': 'מצב',
  'import.th.line': 'שורה {{n}} בקובץ',
  'import.ph.birthdate': 'יום/חודש/שנה',
  'import.ph.noGroup': 'בלי קבוצה',
  'import.ph.none': '—',
  'import.ph.choose': 'בחרו…',
  'import.ph.wasWritten': 'בקובץ: {{text}}',
  'import.row.delete': 'מחיקת השורה',
  'import.row.force': 'ייבוא בכל זאת',
  'import.row.unforce': 'דילוג',
  'import.state.ready': 'מוכן',
  'import.state.sending': 'נשלח…',
  'import.state.added': 'נוסף',
  'import.state.failed': 'נכשל',
  'import.state.skipped': 'דולג — כבר קיים',
  'import.state.convertFailed': 'נוסף · הצירוף לקבוצה נכשל — צרפו מהכרטיס',
  'import.state.beltFailed': 'נוסף · החגורה לא נרשמה — הוסיפו מהכרטיס',
  'import.state.createFailed': 'לא נוסף — השרת סירב. נסו שוב או הוסיפו ידנית',
  'import.problem.missing_first_name': 'חסר שם פרטי',
  'import.problem.missing_contact': 'חסר אימייל וטלפון — צריך דרך אחת ליצור קשר',
  'import.problem.bad_email': 'האימייל לא תקין',
  'import.problem.bad_birthdate': 'תאריך הלידה לא נקרא — יום/חודש/שנה',
  'import.problem.missing_group': 'חסרה קבוצה — בלי שיבוץ החניך לא יופיע באף מסך נוכחות',
  'import.problem.unknown_group': 'הקבוצה לא קיימת במועדון — בחרו מהרשימה',
  'import.problem.unknown_belt': 'החגורה לא בסולם של הקבוצה — בחרו מהרשימה',
  'import.problem.belt_without_group': 'חגורה בלי קבוצה — בחרו קבוצה קודם',
  'import.problem.missing_plan': 'חסר מסלול — בלי מחיר לא ייווצר חיוב והמשפחה לא תופיע בגבייה',
  'import.problem.unknown_plan': 'המסלול לא קיים — בחרו מהרשימה',
  'import.problem.missing_payment': 'חסר הסדר תשלום — בחרו מזומן / צ׳קים / הוראת קבע, או ״עדיין לא שילמו״',
  'import.problem.bad_payment': 'הסדר תשלום לא מוכר — מזומן, צ׳קים, הוראת קבע או ״עדיין לא שילמו״',
  'import.problem.card_payment': 'אשראי לא נרשם כאן — התשלום בכרטיס נסגר לבד דרך האפליקציה. בחרו ״עדיין לא שילמו״',
  'import.problem.minor_without_parent': 'ילד/ה בלי הורה — לחצו על העיפרון ומלאו שם הורה',
  'import.problem.duplicate': 'כבר קיים במערכת — לא ייובא',
  'import.footer.summary': '{{ready}} חניכים מוכנים, {{problems}} שורות לתיקון.',
  'import.footer.hint': 'הייבוא יוצר את החניכים ומצרף לקבוצות. הזמנה נוצרת לכל משפחה אבל לא נשלחת — שולחים אותן מרשימת החניכים, כשתרצו. שורות שלא תוקנו נשארות כאן.',
  'import.footer.none': 'אין שורות מוכנות — תקנו או מחקו את השורות המסומנות.',
  'import.run': 'ייבוא {{n}} חניכים',
  'import.runOne': 'ייבוא חניך אחד',
  'import.running': 'מייבא… {{done}} מתוך {{total}}',
  'import.done.title': '{{trainees}} חניכים נוספו ב־{{families}} משפחות',
  'import.done.held': '{{n}} הזמנות מוכנות וממתינות — לא נשלח דבר',
  'import.done.notNeeded': '{{n}} כבר עם חשבון',
  'import.done.left': '{{n}} שורות נשארו לתיקון',
  'import.done.note': 'לא נשלח שום מייל להורים. ההזמנות מוכנות וממתינות — כשהמועדון יהיה מוכן, שלחו אותן מרשימת החניכים, וכל משפחה תמשיך משם בעצמה: פרטים, הצהרת בריאות ותשלום.',
  'import.done.finish': 'סיום — לרשימת החניכים',
  'import.done.again': 'ייבוא קובץ נוסף',
  'import.done.runLeft': 'ייבוא {{n}} הנותרים',
  'import.invite.held': 'הזמנה מוכנה — לא נשלחה',
  'import.invite.not_needed': 'לא נדרשה — כבר יש חשבון',
  'import.invite.none': 'לא יובא',
  'import.invite.sendNow': 'שלחו עכשיו',
  'import.invite.sentNow': 'נשלח',
  'import.invite.sendFailed': 'השליחה נכשלה',
  'import.beltNote': 'נרשם בייבוא מקובץ — חגורה שהחניך כבר החזיק',
  'import.tpl.prompt.first_name': 'השם הפרטי של החניך/ה. חובה.',
  'import.tpl.prompt.last_name': 'שם המשפחה של החניך/ה.',
  'import.tpl.prompt.birthdate': 'יום/חודש/שנה, למשל 12/04/2018.',
  'import.tpl.prompt.parent_first': 'השם הפרטי של ההורה. ריק = חניך בוגר (18+) עם חשבון משלו.',
  'import.tpl.prompt.parent_last': 'שם המשפחה של ההורה.',
  'import.tpl.prompt.email': 'האימייל של ההורה; לבוגר — שלו. אחים: אותו אימייל בכל שורה. אפשר להשאיר ריק אם מילאתם טלפון — אבל בלי אימייל אי אפשר לשלוח הזמנה.',
  'import.tpl.prompt.phone': 'טלפון ליצירת קשר. נשמר בכרטיס.',
  'import.tpl.prompt.group': 'בחרו מהרשימה. חובה — בלי קבוצה החניך לא משובץ.',
  'import.tpl.prompt.belt': 'בחרו מהרשימה — החגורה שהחניך כבר מחזיק.',
  'import.tpl.prompt.plan': 'בחרו מהרשימה. חובה — בלי מסלול אין מחיר ואין חיוב.',
  'import.tpl.prompt.payment': 'חובה. איך המשפחה כבר שילמה, או ״עדיין לא שילמו״.',
  'import.tpl.listErrorTitle': 'לא ברשימה',
  'import.tpl.listError': 'בחרו ערך מהרשימה הנפתחת של התא.',
  'import.tpl.dateErrorTitle': 'לא תאריך',
  'import.tpl.dateError': 'כתבו תאריך, למשל 12/04/2018.',
  'import.tpl.required': 'חובה',
  'import.tpl.contactRequired': 'אימייל או טלפון — לפחות אחד',
  'import.payment.none': 'עדיין לא שילמו',
  'import.payment.cash': 'מזומן',
  'import.payment.cheque': 'צ׳קים',
  'import.payment.standing_order': 'הוראת קבע',
  ...
  'addStudents.phoneParent': 'טלפון ההורה',
  'addStudents.phoneSelf': 'הטלפון של החניך/ה',
  'addStudents.phoneHint': 'אימייל או טלפון — מספיק אחד. הזמנה לאפליקציה אפשר לשלוח רק לאימייל.',
  'addStudents.duplicateTitle': 'כבר קיים במועדון',
  'addStudents.duplicate': 'כבר יש במועדון חניך בשם {{name}}. אם זה אותו ילד — אל תוסיפו שוב.',
  'addStudents.duplicateAnyway': 'זה ילד אחר — הוסיפו בכל זאת',
  ...
  'addStudents.groupRequired': 'חובה לבחור קבוצה — בלי שיבוץ החניך לא יופיע באף מסך נוכחות.',
