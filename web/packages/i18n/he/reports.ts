...
export const reports: Bundle = {
  ...
  'privacy.terms.s4.body':
    'המחירים ותנאי הביטול וההחזר של המועדון מפורטים בתקנון ותנאי התשלום שאישרתם. זכויותיכם לפי חוק הגנת הצרכן עומדות בכל מקרה, ואין בתקנון כדי לגרוע מהן. בקשת ביטול או החזר מופנית למנהל המועדון, דרך פרטי הקשר שבמסך הפרופיל. תשלומי אשראי מעובדים על ידי ספק הסליקה uPay ואיננו שומרים פרטי כרטיס. הוראת קבע אינה נפתחת דרך האפליקציה, ותשלום שהתקבל בה מסומן ידנית על ידי המועדון.',
