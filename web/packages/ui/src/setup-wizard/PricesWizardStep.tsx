...
import type { WizardPricePlan, WizardPricesClient } from './step-clients'
import { PlanFrequencyPicker, PlanPreview, frequencyLabel } from './PlanFrequency'
import './prices-wizard.css'
 ...
 */
export function registerPricesWizardStep(client: WizardPricesClient): void {
